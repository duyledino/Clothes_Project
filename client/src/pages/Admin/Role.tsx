...
// Mock data
const MOCK_ROLES = [
  { role_id: "1", role_name: "Admin", description: "Full access to all features" },
  { role_id: "2", role_name: "Manager", description: "Can manage products and orders" },
  { role_id: "3", role_name: "Customer", description: "Standard user access" },
];
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden relative">
        ...
        <header className="bg-white border-b border-slate-200 px-8 py-5 flex flex-col gap-4 flex-shrink-0 z-10">
          <div className="flex justify-between items-start">
            <div>
              <h2 className="text-2xl font-black tracking-tight">Role Management</h2>
